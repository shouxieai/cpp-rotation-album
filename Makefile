...
stdcpp    := c++11
cuda_arch := 
ocv_path  := /datav/software/anaconda3/lib/python3.9/site-packages/akiwi/cpp-packages/opencv4.2
...
link_sys       := stdc++ dl
link_librarys  := $(link_sys) $(link_opencv)
